...
const messages = [
  ...
  },
  {
    ...
    entrance: false,
    channels: ['test', 'friday', 'direct'],
    callback: require('./faceapp').drawSmile,
  },
  {
    messages: ['SMILE2 '],
    startFrom: true,
    entrance: false,
    channels: ['test', 'friday', 'direct'],
    callback: require('./faceapp').drawSmile2,
  },
  {
    messages: ['WARM '],
    startFrom: true,
    entrance: false,
    channels: ['test', 'friday', 'direct'],
    callback: require('./faceapp').drawHot,
  },
  {
    messages: ['OLD '],
    startFrom: true,
    entrance: false,
    channels: ['test', 'friday', 'direct'],
    callback: require('./faceapp').drawOld,
  },
  {
    messages: ['YOUNG '],
    startFrom: true,
    entrance: false,
    channels: ['test', 'friday', 'direct'],
    callback: require('./faceapp').drawYoung,
  },
  {
    messages: ['FEMALE2 '],
    startFrom: true,
    entrance: false,
    channels: ['test', 'friday', 'direct'],
    callback: require('./faceapp').drawFemale2,
  },
  {
    messages: ['FEMALE '],
    startFrom: true,
    entrance: false,
    channels: ['test', 'friday', 'direct'],
    callback: require('./faceapp').drawFemale,
  },
  {
    messages: ['MALE '],
    startFrom: true,
    entrance: false,
    channels: ['test', 'friday', 'direct'],
    callback: require('./faceapp').drawMale,
  },
  {
    messages: ['PAN '],
    startFrom: true,
    entrance: false,
    channels: ['test', 'friday', 'direct'],
    callback: require('./faceapp').drawPan,
  },
  {
    messages: ['HITMAN '],
    startFrom: true,
